...
require_once('assets/libraries/sitemap-php/Sitemap.php');
require_once('assets/libraries/DB/vendor/autoload.php');
require_once('assets/libraries/coinpayments.php');
...
require_once('assets/libraries/s3/aws-autoloader.php');
require_once("assets/libraries/spaces/spaces.php");
require_once('assets/libraries/ftp/vendor/autoload.php');
require_once('assets/libraries/twilio/vendor/autoload.php');
require_once('assets/libraries/SimpleImage-master/src/claviska/SimpleImage.php');
