...
$pages_without_access_token = array('get-site-settings', 'auth', 'regsiter', 'send-reset-password-email', 'create-account');
$pages_without_loggedin = array('auth', 'regsiter', 'get-site-settings', 'send-reset-password-email', 'create-account');
