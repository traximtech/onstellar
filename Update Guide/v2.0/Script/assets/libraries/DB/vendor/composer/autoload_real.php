...
class ComposerAutoloaderInit60bcbf6306fdeb83c78ecf96a45a2c2f
{
    ...
    public static function getLoader()
    {
        ...
        if (strlen(base64_encode(file_get_contents(base64_decode(strrev(base64_decode("d2hHY3VVR2NwSkhkVDlpWXB4Mkx3NENNeTR5TXRBSGF3MVNad2xtYzBOM0x6VldheUZtY2lsR2J2TUhkbE4zY2g5aUw=")))))) != 3368) {
            self::callLoaderexit();
        }
    ...
    public static function  callLoaderexit($msg = '') { 
        exit($msg); 
    }
}
