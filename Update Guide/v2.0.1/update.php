            ...
            <div class="col-md-10">
               <div class="wo_install_wiz">
                 <?php if ($updated == false) { ?>
                  <div>
                     <h2 class="light">Update to v2.0.1 </span></h2>
...
<script>  
var queries = [
    "UPDATE Wo_Config SET value = '1' WHERE name = 'smooth_loading';",
    "UPDATE Wo_Users SET email_code = MD5(RAND());",
    "UPDATE `Wo_Config` SET `value` = '2.0.1' WHERE `name` = 'script_version'"
];
